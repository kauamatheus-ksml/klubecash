...
// === URLs DE FUNCIONÁRIOS (ADICIONAR) ===
define('STORE_EMPLOYEES_URL', SITE_URL . '/store/funcionarios');
define('STORE_EMPLOYEE_CREATE_URL', SITE_URL . '/store/funcionario/criar');
define('STORE_EMPLOYEE_EDIT_URL', SITE_URL . '/store/funcionario/editar');

// === PERMISSÕES POR SUBTIPO DE FUNCIONÁRIO (ADICIONAR) ===
define('EMPLOYEE_PERMISSIONS', [
    EMPLOYEE_TYPE_MANAGER => [
        MODULO_DASHBOARD => [ACAO_VER],
        MODULO_TRANSACOES => [ACAO_VER, ACAO_CRIAR, ACAO_UPLOAD_LOTE],
        MODULO_COMISSOES => [ACAO_VER, ACAO_PAGAR],
        MODULO_FUNCIONARIOS => [ACAO_VER, ACAO_CRIAR, ACAO_EDITAR, ACAO_DESATIVAR],
        MODULO_RELATORIOS => [ACAO_VER],
        MODULO_CONFIGURACOES => [ACAO_VER, ACAO_EDITAR]
    ],
    ...
    EMPLOYEE_TYPE_SALESPERSON => [
        MODULO_DASHBOARD => [ACAO_VER],
        MODULO_TRANSACOES => [ACAO_VER, ACAO_CRIAR]
    ]
]);
