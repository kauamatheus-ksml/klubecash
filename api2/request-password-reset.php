...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        api_log("PONTO 6: Chamando AuthController::recoverPassword para email: " . $email);
        $result = AuthController::recoverPassword($email);
        api_log("PONTO 7: Resultado de AuthController::recoverPassword: " . json_encode($result));
