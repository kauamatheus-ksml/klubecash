...
try {
    ...
    require_once __DIR__ . '/../utils/Email.php'; // AuthController.php usa Email.php
    // require_once __DIR__ . '/../utils/Validator.php'; // Se o AuthController.php não incluir o Validator.php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        api_log("PONTO 6: Chamando AuthController::register para email: " . $email);
        $result = AuthController::register($nome, $email, $telefone, $senha, $tipo);
        api_log("PONTO 7: Resultado de AuthController::register: " . json_encode($result));
